...
>
    <div class={asSidebar ? " relative p-4 inset-0 m-auto max-w-1/4" : ""}>
        ...
        <p class="my-4 text-lg">
            I've been developing games since 2017 in teams of up to 30 using Unreal Engine or Unity.
            I don't limit myself to games though! I've got experience in web, software and graphics
            development.
        </p>
        <div class="contact">
